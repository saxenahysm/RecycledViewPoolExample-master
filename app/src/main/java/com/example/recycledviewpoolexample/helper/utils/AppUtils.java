...
public class AppUtils {
     ...
     * @return
     */
    public static Bitmap findViewBitmap(final List<SubItemModel> currentPDFModels,
                                        int deviceWidth, int deviceHeight,
                                        SubItemAdapter pdfRootAdapter,
                                        RecyclerView mPDFCreationRV, View mPDFCreationView) {
